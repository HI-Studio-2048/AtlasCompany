...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    // Blog
    'blog.badge': 'Atlas Blog',
    'blog.headline': 'Insights & Guides',
    'blog.sub': 'Expert insights on company formation, trademark protection, tax strategy, and global expansion.',
  ...
  zh: {
    ...
    'blog.badge': 'Atlas 博客',
    'blog.headline': '洞察与指南',
    'blog.sub': '关于公司注册、商标保护、税务策略和全球扩张的专家见解。',
